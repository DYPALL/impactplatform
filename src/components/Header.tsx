    ...
    <header className="w-full border-b border-[color:var(--impact-border)] bg-white">
      ...
      >
        <div className="flex items-center gap-2 rounded-full border border-white/40 bg-white/60 px-3 py-2 shadow-[0_10px_30px_-10px_rgba(80,33,129,0.35)] backdrop-blur-xl">
          ...
          <Link
            to="/resource-hub"
            className={`flex flex-col items-center gap-0.5 rounded-full px-3 py-1.5 text-[11px] font-bold transition ${pathname === "/resource-hub" ? "bg-[color:var(--impact-green)] text-white" : "text-[color:var(--impact-purple)]"}`}
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
          ...
          <Link
            to="/send-us-a-message"
            className={`flex flex-col items-center gap-0.5 rounded-full px-3 py-1.5 text-[11px] font-bold transition ${pathname === "/send-us-a-message" ? "bg-[color:var(--impact-green)] text-white" : "text-[color:var(--impact-purple)]"}`}
          >
