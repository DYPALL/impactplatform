      ...
      <div className="mx-auto grid max-w-[1440px] gap-10 px-6 py-16 md:grid-cols-[1.5fr_1fr] lg:px-[120px]">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/70">
            ...
            <li>
              <Link to="/resource-hub" className="inline-flex items-center gap-2 hover:text-white">
            ...
            <li>
              <Link to="/send-us-a-message" className="inline-flex items-center gap-2 hover:text-white">
