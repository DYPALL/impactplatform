                ...
                <div className="rounded-2xl bg-white/10 p-3 md:p-4 lg:rounded-2xl lg:p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 md:gap-4">
                    {AREAS.map((a) => (
                      <div
                        key={a.key}
                        className="min-w-0 overflow-hidden rounded-2xl px-2 py-2.5 text-center sm:px-3 md:px-4 md:py-3.5 lg:px-5 lg:py-4"
                        style={{ backgroundColor: a.softBg }}
                      >
                        <p className="line-clamp-2 break-words text-balance text-[10px] font-semibold leading-tight sm:text-[11px] md:text-[13px] lg:text-[14px]" style={{ color: a.softText }}>
                          {a.title}
                        </p>
