...
function AuthPage() {
  ...
  async function handleOAuth(provider: "google" | "apple") {
    ...
    try {
      ...
      if (result.error) { setError(result.error.message || "Social log-in failed"); return; }
        ...
        <aside className="relative overflow-hidden bg-[color:var(--impact-purple)] px-8 py-14 text-white lg:w-[45%] lg:px-[80px] lg:py-16 xl:px-[120px]">
          ...
          <div className="absolute bottom-8 left-8 right-8 hidden lg:left-[80px] lg:right-[80px] lg:block xl:left-[120px] xl:right-[120px]">
            ...
            <p className="mt-4 max-w-[440px] text-[11px] leading-relaxed text-white/70">
              IMPACT is co-funded by the European Union. This platform is
              designed as a standalone digital resource to empower Local Youth
              Council stakeholders with self-assessment, improvement guidelines
              and planning tools — scalable and ready to grow with your needs.
            </p>
          </div>
        </aside>
        ...
        <section className="flex flex-1 items-center justify-center px-6 py-12 lg:px-16">
          <div className="w-full max-w-[440px]">
            ...
            <button
              ...
              disabled={busy}
              className="mt-3 flex w-full items-center justify-center gap-3 rounded-full border border-black/15 bg-white py-3 text-[14px] font-bold text-[color:var(--impact-ink)] transition hover:bg-black/5 disabled:opacity-50"
            >
