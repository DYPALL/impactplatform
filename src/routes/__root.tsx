...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Work+Sans:wght@700;800&display=swap",
      },
    ],
  }),
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {!pathname.startsWith("/auth") && !pathname.startsWith("/questionnaire") && !pathname.startsWith("/results") && <Header />}
